...
| Domain | Technologies |
| :--- | :--- |
| **Languages** | Python (Focus), C++, SQL, Bash |
| **Cloud & DevOps** | Microsoft Azure (Certified), Docker, Git |
| **Data & AI** | PyTorch, Google Colab, Pandas |
| **Certifications** | Cisco Python Essentials 1 & 2, IBM Cloud Fundamentals, Azure Fundamentals |
...
| **Turkish** | Native |
| **English** | Fluent |
| **Polish** | Learning & Actively Developing |
